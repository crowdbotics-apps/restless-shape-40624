"""
Django settings for restless_shape_40624 project.
...
ROOT_URLCONF = 'restless_shape_40624.urls'
...
WSGI_APPLICATION = 'restless_shape_40624.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restless_shape_40624 API",
    "DESCRIPTION": "API documentation for restless_shape_40624 App",
    "VERSION": "v1",
}
